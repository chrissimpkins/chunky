...
def version_read():
    settings_file = open(os.path.join(os.path.dirname(__file__), 'lib', 'chunky', 'settings.py')).read()
...
setup(
    ...
    description='Asynchronous chunked HTTP requests for large files',
    long_description=(docs_read('README.rst')),
    url='https://github.com/chrissimpkins/chunky',
    license='MIT license',
